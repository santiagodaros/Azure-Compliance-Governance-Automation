...
- [Automation Layer](#automation-layer)
  - [ASR Parallel Test Failover](#asr-parallel-test-failover)
    - [SRE Guardrails](#sre-guardrails)
    - [Execution Phases](#execution-phases)
    - [HTML Executive Report](#html-executive-report)
  - [AVD User Audit](#avd-user-audit)
...
│  │  Phase 2 ──► Global Polling [simultaneous]                    │   │
│  │  Phase 3 ──► Boot → [Net ║ OS ║ Disk ║ SQL] via ThreadJob    │   │
│  │                                                               │   │
...
│  │                                                               │   │
│  │  Per App Group: Desktop Virtualization User assignments       │   │
│  │  Per Host Pool: RDP properties (device/drive/clip/printer)    │   │
